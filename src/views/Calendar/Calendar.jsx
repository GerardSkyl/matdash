  ...
  render() {
    ...
    return (
      <Card>
        ...
        <Button color="info" href="https://material-ui.com/" target="_blank">
          Documentacion del material ui
        </Button>

        <Button
          color="info"
          href="https://demos.creative-tim.com/material-dashboard-react/?_ga=2.22337458.887779157.1541039424-1404954280.1539966480#/documentation/tutorial"
          target="_blank"
        >
          Documentacion del material dashboard
        </Button>
        <CardBody>
          <GridContainer>
